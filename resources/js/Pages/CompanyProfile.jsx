            ...
            <div className="container flex mx-auto px-4 md:px-8 xl:px-16 py-16 pb-24 pt-24 md:pt-8 lg:pt-32 justify-between md:items-end">
                <div className="md:w-[51%]">
                    ...
                    <p className="pt-4 text-xs lg:text-base text-center md:text-left">
                        ...
                        Koporasi yang menaungi 45 Perusahaan yang terintegrasi
                        dengan 4 linear bisnis yaitu Logistic, Chicken
                        Integration, Distributor, serta Food Beverage
                    </p>
                    <div className="flex justify-center gap-6 lg:gap-12 pt-8 md:hidden">
                        ...
                        <div>
                            <div className="flex gap-2 pb-4 items-center">
                                ...
                                <Link href="http://tako.co.id/" target="_blank">
                                    <p className="text-xs lg:text-base">
                                        http://tako.co.id/
                                    </p>
                                </Link>
                    ...
                    <div className="pt-8 md:pt-4 flex gap-4 justify-center md:justify-start">
                        <Link>
